...
mkdir -p /tmp/age-install && tar xzf /tmp/age.tar.gz -C /tmp/age-install
cp /tmp/age-install/age/age /usr/local/bin/
cp /tmp/age-install/age/age-keygen /usr/local/bin/
